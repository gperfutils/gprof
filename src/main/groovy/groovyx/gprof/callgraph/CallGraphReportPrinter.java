...
public class CallGraphReportPrinter implements ReportPrinter<CallGraphReportThreadElement> {
                    ...
                    if (parent.getIndex() == 0) {
                        lines.add(
                                Utils.hashMap(
                                        ...
                                        "",
                                        Column.SELF_TIME,
                                        Formatter.time(parent.getSelfTime()),
                                        Column.CHILDREN_TIME,
                                        Formatter.time(parent.getChildrenTime()),
                                        Column.CALLS,
                ...
                if (element instanceof CallGraphReportWholeCycleElement) {
                    lines.add(
                            Utils.hashMap(
                                    ...
                                    "",
                                    Column.SELF_TIME,
                                    Formatter.time(childRef.getSelfTime()),
                                    Column.CHILDREN_TIME,
                                    Formatter.time(childRef.getChildrenTime()),
                                    Column.CALLS,
                    ...
                    lines.add(
                        Utils.hashMap(
                                ...
                                "",
                                Column.SELF_TIME,
                                Formatter.time(childParent.getSelfTime()),
                                Column.CHILDREN_TIME,
                                Formatter.time(childParent.getChildrenTime()),
                                Column.CALLS,
                                Formatter.childCalls(
    ...
    private Object primaryLine(CallGraphReportMethodElement element) {
        ...
        return Utils.hashMap(
                ...
                Column.SELF_TIME,
                Formatter.time(element.getSelfTime()),
                Column.CHILDREN_TIME,
                Formatter.time(element.getChildrenTime()),
                Column.CALLS,
